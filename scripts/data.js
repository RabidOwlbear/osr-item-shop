...
OSRIS.itemData = [
  ...
  { source: 'oseSrd', type: 'weapons', name: 'Crossbow', cost: 30, maxAllowed: 1, qty: 1, stack: false , pack: 'osr-item-shop.osr items', id: 'srd028'},
  { source: 'oseSrd', type: 'weapons', name: 'Dagger', cost: 3, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd028'},
  { source: 'oseSrd', type: 'weapons', name: 'Halberd', cost: 7, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd030'},
  { source: 'oseSrd', type: 'weapons', name: 'Hand Axe', cost: 4, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd031'},
  { source: 'oseSrd', type: 'weapons', name: 'Javelin', cost: 1, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd032'},
  { source: 'oseSrd', type: 'weapons', name: 'Lance', cost: 5, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd033'},
  { source: 'oseSrd', type: 'weapons', name: 'Mace', cost: 5, maxAllowed: 1, qty: 1, stack: false , pack: 'osr-item-shop.osr items', id: 'srd034'},
  { source: 'oseSrd', type: 'weapons', name: 'Longbow', cost: 40, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd035'},
  { source: 'oseSrd', type: 'weapons', name: 'Shortbow', cost: 25, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd036'},
  { source: 'oseSrd', type: 'weapons', name: 'Shortsword', cost: 7, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd037'},
  { source: 'oseSrd', type: 'weapons', name: 'Silver Dagger', cost: 30, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd038'},
  { source: 'oseSrd', type: 'weapons', name: 'Sling', cost: 2, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd039'},
  { source: 'oseSrd', type: 'weapons', name: 'Spear', cost: 4, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd040'},
  { source: 'oseSrd', type: 'weapons', name: 'Staff', cost: 2, maxAllowed: 1, qty: 1, stack: false , pack: 'osr-item-shop.osr items', id: 'srd041'},
  { source: 'oseSrd', type: 'weapons', name: 'Sword', cost: 10, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd042'},
  { source: 'oseSrd', type: 'weapons', name: 'Two-handed Sword', cost: 15, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd043'},
  { source: 'oseSrd', type: 'weapons', name: 'Warhammer', cost: 5, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd044'},
