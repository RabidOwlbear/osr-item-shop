...
OSRIS.itemData = [
  ...
  { source: 'oseSrd', type: 'armor', name: 'Leather Armor', cost: 20, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd045'},
  { source: 'oseSrd', type: 'armor', name: 'Plate Mail', cost: 60, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd046'},
  { source: 'oseSrd', type: 'armor', name: 'Shield', cost: 10, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd047'},
  { source: 'oseSrd', type: 'armor', name: 'Shield (Steel)', cost: 10, maxAllowed: 1, qty: 1, stack: false , pack: 'osr-item-shop.osr items', id: 'srd048'},
  { source: 'oseSrd', type: 'armor', name: 'Shield (Wood)', cost: 10, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd040'},
  { source: 'oseSrd', type: 'ammunition', name: 'Arrows (quiver of 20)', cost: 5, maxAllowed: 1 , qty:20, stack: false, pack: 'osr-item-shop.osr items', id: 'srd050'},
  { source: 'oseSrd', type: 'ammunition', name: 'Crossbow bolts (case of 30)', cost: 10, maxAllowed: 30 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd051'},
  { source: 'oseSrd', type: 'ammunition', name: 'Silver tipped arrow (1)', cost: 5, maxAllowed: 1 , qty: 1, stack: false, pack: 'osr-item-shop.osr items', id: 'srd052'},
  { source: 'oseSrd', type: 'ammunition', name: 'Sling Stones', cost: 1, maxAllowed: 1 , qty: 1, stack: true, pack: 'osr-item-shop.osr items', id: 'srd053'},
